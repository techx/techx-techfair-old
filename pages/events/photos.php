...
$sample = array(
	...
	'/img/photos/2-37' => 'Oracle and Sun Microsystems.',
...
foreach($sample as $filename=>$caption) {
    echo '<a href="'.$filename.'.jpg" rel="lightbox[tf]" title="'.$caption.'"><img src="'.$filename.'-thumb.jpg" style="padding-left: 5px; padding-right: 5px; padding-top: 4px;"></a>';
}
?>
